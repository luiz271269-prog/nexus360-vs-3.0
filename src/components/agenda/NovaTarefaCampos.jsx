...
import { CATEGORIAS } from './agendaFluxos';
...
export default function NovaTarefaCampos({ form, alterar, usuario, usuarios }) {
  return <div className="space-y-4">
    ...
    <div className="grid grid-cols-2 gap-3"><CampoSelect label="Categoria" value={form.categoria} onChange={v => alterar('categoria', v)} options={CATEGORIAS} /><CampoSelect label="Atividade" value={form.tipo} onChange={v => alterar('tipo', v)} options={TASK_TYPES} /><CampoSelect label="Prioridade" value={form.prioridade} onChange={v => alterar('prioridade', v)} options={PRIORITIES} /></div>
