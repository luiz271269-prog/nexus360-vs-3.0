...
import { MoreVertical, Edit, Trash2, User, Phone, Mail, CheckCircle, AlertCircle } from "lucide-react";
...
export default function VendedorTable({ vendedores, onEditar, onExcluir }) {
  ...
  const getVinculoStatus = (vendedorEmail) => {
    const usuarioVinculado = usuarios.find(u => u.email === vendedorEmail);
