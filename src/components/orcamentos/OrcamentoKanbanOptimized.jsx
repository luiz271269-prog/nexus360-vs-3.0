  ...
  return (
    <div style={{ width: 160, minWidth: 160, flexShrink: 0 }} className="flex flex-col">
      ...
      <Droppable droppableId={status}>
        ...
        <div
          ref={provided.innerRef}
          {...provided.droppableProps} className="bg-slate-50 mx-1 px-1 rounded-b-xl border-l-4 border-r-4 border-b-4 border-amber-500 space-y-1.5 flex-1 transition-colors duration-150"
