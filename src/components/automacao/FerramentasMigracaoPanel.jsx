...
export default function FerramentasMigracaoPanel() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          <h2 className="text-2xl font-bold text-slate-900">Ferramentas de Migração</h2>
      ...
      <div className="text-center text-xs text-slate-500 pt-4 border-t">
        <p>⚠️ Sempre execute DRY-RUN antes de aplicar alterações reais</p>
      </div>
    </div>
  );
}