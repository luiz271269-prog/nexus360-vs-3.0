  ...
  return (
    <>
      ...
      <TabsContent value="etiquetas" className="h-full m-0 overflow-hidden">
        <div className="h-full overflow-y-auto p-6">
          <div className="max-w-2xl mx-auto bg-purple-50 border border-purple-200 rounded-lg p-6 text-center">
            <h3 className="text-lg font-semibold text-purple-900 mb-2">Gerenciamento de etiquetas foi centralizado</h3>
            <p className="text-sm text-purple-700 mb-4">Todas as etiquetas (Contato, Conversa e Deduplicação) agora ficam em um único lugar, junto com os Playbooks.</p>
            <a href="/Automacoes" className="inline-block bg-purple-600 hover:bg-purple-700 text-white px-4 py-2 rounded-lg text-sm font-medium">Ir para Automações → Etiquetas</a>
          </div>
        </div>
      </TabsContent>
