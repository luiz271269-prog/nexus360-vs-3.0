...
export default function BarraClassificacaoObrigatoria({ nomeContato, onClassificar }) {
  ...
  return (
    <div className="mx-2 md:mx-3 mb-2 mt-2 rounded-2xl border border-amber-200 bg-gradient-to-r from-amber-50 via-orange-50 to-amber-50 shadow-sm overflow-hidden text-[#181963]">
      <div className="flex flex-col md:flex-row md:items-center gap-3 px-3 mx-2 bg-[hsl(var(--background))] text-[hsl(var(--card-foreground))]">
