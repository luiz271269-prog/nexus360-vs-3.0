...
import { Download, CheckCircle2, XCircle, AlertCircle, Minus } from 'lucide-react';
...
export default function PlanilhaComparativaEnvios() {
  ...
  const comparacaoRegras = [
    ...
    { regra: 'Personalização mensagem', broadcast: '✅', promocao: '✅', fila: '✅', detalhe: '{{nome}}/{{empresa}} (broadcast) | template (promo)' },
  ...
  const comparacaoFluxo = [
    { etapa: '1. Gatilho', broadcast: 'UI - Botão "Envio Massa"', promocao: 'UI - Botão "Auto Promoções"', fila: 'Automação (5 min)' },
    { etapa: '2. Busca dados', broadcast: 'Contact + Thread (lote)', promocao: 'Contact + Thread + Promos (lote)', fila: 'Contact + Thread + Promo (individual)' },
    { etapa: '3. Validação inicial', broadcast: 'telefone + bloqueios + thread', promocao: 'telefone + bloqueios + thread', fila: 'Assume válido' },
    { etapa: '4. Validação cooldown', broadcast: '❌ Não valida', promocao: '✅ 12h universal', fila: '✅ Cancelamento por resposta' },
    { etapa: '5. Seleção conteúdo', broadcast: 'Personaliza mensagem', promocao: 'Template saudação + filtra promo', fila: 'Promoção já definida' },
    { etapa: '6. Envio', broadcast: 'enviarWhatsApp (gateway)', promocao: 'enviarWhatsApp (saudação)', fila: 'sendPromotion (promo)' },
    { etapa: '7. Persistência', broadcast: '⚠️ Gateway deve persistir', promocao: '✅ Message + Thread', fila: '✅ Message + Contact' },
    { etapa: '8. Agendamento', broadcast: '❌ N/A', promocao: '✅ WorkQueueItem', fila: '❌ Marca processado' },
    { etapa: '9. Log final', broadcast: '✅ AutomationLog', promocao: '✅ AutomationLog', fila: '❌ GAP P2' }
  ];
  ...
  const gaps = [
    { 
      ...
      impacto: 'Mensagens enviadas mas invisíveis na UI', 
    ...
    { 
      ...
      impacto: 'Rotação não persiste escolha, cooldown não registrado', 
    ...
    { 
      ...
      impacto: 'Sem auditoria de execução do worker', 
    ...
    { 
      ...
      impacto: 'Conversa não sobe para o topo após promoção', 
    ...
    { 
      ...
      funcao: 'Global', 
      impacto: 'Sem métricas de: Promotion.contador_envios, Contact.promocoes_recebidas[id]', 
