      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-6 xl:grid-cols-12 gap-3">
        ...
        <div className="sm:col-span-2 lg:col-span-3 xl:col-span-3 min-w-0">
          ...
          <Input
            ...
            className="h-9 text-xs px-3 py-2 bg-slate-800/50 border-cyan-500/30 focus:border-cyan-400 focus:ring-cyan-400/50 text-white placeholder:text-slate-400" />
        </div>
        ...
        <div className="xl:col-span-1 min-w-0">
          ...
          <Input
            ...
            className="h-9 w-full text-xs px-2 py-1 bg-slate-800/50 border-emerald-500/30 focus:border-emerald-400 focus:ring-emerald-400/50 text-white font-mono text-center" />
        </div>
        ...
        <div className="xl:col-span-1 min-w-0">
          ...
          <Input
            ...
            className="h-9 w-full text-xs px-2 py-1 bg-slate-800/50 border-blue-500/30 focus:border-blue-400 focus:ring-blue-400/50 text-white font-mono text-center" />
        </div>
        ...
        <div className="xl:col-span-1 min-w-0">
          ...
          <Input
            ...
            className="h-9 w-full text-xs px-2 py-1 bg-slate-800/50 border-red-500/30 focus:border-red-400 focus:ring-red-400/50 text-white font-mono text-center" />
        </div>

        {/* Custo Operacional % */}
        <div className="xl:col-span-1 min-w-0">
          <Label className="text-xs font-semibold bg-gradient-to-r from-violet-400 to-purple-400 bg-clip-text text-transparent leading-none mb-2 block">
            C.Op%
          </Label>
          <Input
            type="number"
            ...
            className="h-9 w-full text-xs px-2 py-1 bg-slate-800/50 border-violet-500/30 focus:border-violet-400 focus:ring-violet-400/50 text-white font-mono text-center" />
        </div>
        ...
        <div className="xl:col-span-1 min-w-0">
          ...
          <Input
            ...
            className="h-9 w-full text-xs px-2 py-1 bg-slate-800/50 border-amber-500/30 focus:border-amber-400 focus:ring-amber-400/50 text-white font-mono text-center" />
        </div>

        {/* Link da Página */}
        <div className="lg:col-span-3 xl:col-span-2 min-w-0">
          <Label className="text-xs font-semibold bg-gradient-to-r from-teal-400 to-cyan-400 bg-clip-text text-transparent leading-none flex items-center gap-1 mb-2">
            <span className="text-teal-400">🔗</span> Link de origem
          </Label>
          <Input
            placeholder="https://..."
            value={config.linkPagina}
            onChange={(e) => handleChange('linkPagina', e.target.value)}
            className="h-9 text-xs px-3 py-2 bg-slate-800/50 border-teal-500/30 focus:border-teal-400 focus:ring-teal-400/50 text-white placeholder:text-slate-400" />
        </div>
