...
export default function ContatosInteligentesPanel() {
  ...
  const abrirConversa = async (clienteData) => {
    try {
  ...
  const renderCardContato = (cliente) => (
    <div
  ...
  const monitorar = clientes.filter(c => !criticos.includes(c) && !altos.includes(c));
  ...
  return (
    <div className="w-full">
      ...
      <div className="flex items-center justify-between mb-4">
        <div>
          <h2 className="text-xl font-bold text-slate-900">Contatos Inteligentes</h2>
          ...
          <div className="flex gap-6 min-w-max">
            ...
            <div className="flex-shrink-0 w-80">
              ...
              <div className="flex flex-col gap-3">
                {criticos.map(renderCardContato)}
              </div>
            </div>
            ...
            <div className="flex-shrink-0 w-80">
              ...
              <div className="flex flex-col gap-3">
                {altos.filter(a => a.prioridadeLabel === 'ALTO').map(renderCardContato)}
              </div>
            </div>
            ...
            <div className="flex-shrink-0 w-80">
              <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-lg p-4 mb-3 border border-blue-200">
                <div className="flex items-center justify-between">
                  ...
                  <Badge className="bg-blue-600 text-white">{monitorar.length}</Badge>
                </div>
              </div>
              <div className="flex flex-col gap-3">
                {monitorar.map(renderCardContato)}
              </div>
            </div>
          </div>
        </div>
