...
export default function UsuariosPage() {
  ...
  async function carregarUsuarios() {
    ...
    return users.map(u => ({
      ...
      foto_url: u.foto_url || '',
      telefone_particular: u.telefone_particular || '',
      notificacoes_config: u.notificacoes_config || { receber_push: true, receber_whatsapp: false, receber_email: false },
      ...
      // Contas de e-mail (IMAP/SMTP) do usuário (uma ou várias)
  ...
  async function salvarUsuario(usuario) {
    ...
    let payload = {
      ...
      telefone_particular: usuario.telefone_particular || '',
      notificacoes_config: usuario.notificacoes_config || { receber_push: true, receber_whatsapp: false, receber_email: false },
      ...
      email_accounts: usuario.email_accounts || [],
    ...
    try {
      ...
      if (encontrado) {
        return {
          ...
          telefone_particular: encontrado.telefone_particular || '',
          notificacoes_config: encontrado.notificacoes_config || { receber_push: true, receber_whatsapp: false, receber_email: false },
          ...
          email_accounts: encontrado.email_accounts || [],
